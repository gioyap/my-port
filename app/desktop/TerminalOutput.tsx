...
const terminalProjectSlugs = new Set(["bluesky-container-tracking-system", "uclear-customs-crm-client-portal", "woodpaneldesigner", "webecommerce", "preventivemaintenance", "prodinline", "plant-performance-management-system", "church-ministry-platform"]);
